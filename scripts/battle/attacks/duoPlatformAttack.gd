...
func pre_attack():
	...
	a_vars.battle_box.set_box_size([250,240,380,390])
...
func bones_part_one():
	var rightDoobie = a_vars.attack_manager.doobie_bullet(0,Vector2(410,400),0,0,0,0,false)
	await get_tree().create_timer(.5).timeout
	a_vars.attack_manager.bone_stab(0,Vector2(200,390),240,50,.8,99999,0,true)
	a_vars.attack_manager.platform(0,Vector2(290,330),0,0,10,true)
